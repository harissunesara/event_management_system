...
$sql = "SELECT name as company_name,username,email,phone_no as contact_no,contact_person,created_at,updated_at,status  from tblcompany WHERE id=:id";
...
<head>
    ...
    <title>EMS | Manage Companys</title>
...
<?php include_once('includes/leftbar.php');?>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"> Manage Companys</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <div align="right">
...
<?php } ?>
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
<?php
$sql = " SELECT id,name as company_name,username,email,phono_no as contact_no,contact_person,created_at,updated_at,status  from tblcompany";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
<td>
<a href="edit-company.php?cid=<?php echo htmlentities($row->id);?>">
